...
def getWordScore(word, n):
    ...
    for char in word:
        for dict in SCRABBLE_LETTER_VALUES:
            if dict == char:
                baseScore += SCRABBLE_LETTER_VALUES [dict]
                letterCount +=1
            if letterCount != n:
                endScore = baseScore*letterCount
            else:
                endScore = baseScore*letterCount+50
    return endScore
...
def updateHand(hand, word):
    ...
    for letterInWord in word:
        myHand [letterInWord] -=1
        if myHand [letterInWord] < 0:
            myHand [letterInWord] = 0
    newDict = myHand
    return newDict    
...
def calculateHandlen(hand):
    ...
    returns: integer
    """
    NumberOfLettersInHand = 0
    for char in hand:
        NumberOfLettersInHand += hand[char]
    return NumberOfLettersInHand
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while howManyLettersInHand > 0:
        ...
        if userInput == ".":
            ...
            score += tempscore
            print (userInput, "earned ", tempscore, "points. Total score:", score)
            print (" ")
            hand = updateHand(hand, userInput)
            howManyLettersInHand -= len(userInput)


    if howManyLettersInHand == 0:
